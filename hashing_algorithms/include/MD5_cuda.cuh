...
class MD5_cuda : public IHashingAlgorithm {
    ...
    unsigned char *digestBuffer = nullptr;
    constexpr static unsigned char S[64] = {
            7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22,
            5, 9, 14, 20, 5, 9, 14, 20, 5, 9, 14, 20, 5, 9, 14, 20,
            4, 11, 16, 23, 4, 11, 16, 23, 4, 11, 16, 23, 4, 11, 16, 23,
            6, 10, 15, 21, 6, 10, 15, 21, 6, 10, 15, 21, 6, 10, 15, 21
    };
    static const unsigned int DEFAULT_DIGEST_BUFFER[4];
...
public:
    ...
    unsigned char *calculateHashSum(const char *word) override {
        ...
        unsigned char *toReturn = digestBuffer;
        digestBuffer = nullptr;
        return toReturn;
    };
